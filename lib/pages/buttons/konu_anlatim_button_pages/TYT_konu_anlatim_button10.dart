...
import 'package:biyoloji_16_03_2023/pages/TYT_PAGES/konu_anlatim_pages/TYT_konu_anlatim_page10.dart';
import 'package:flutter/material.dart';

import '../../../product/project_colors.dart';

class TYTKonuAnlatimButton10 extends StatelessWidget {
  const TYTKonuAnlatimButton10({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TYTKonu10Page()));
              },
              child: Padding(
