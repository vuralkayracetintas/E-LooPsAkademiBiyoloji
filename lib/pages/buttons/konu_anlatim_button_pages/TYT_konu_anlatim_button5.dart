...
import 'package:biyoloji_16_03_2023/pages/TYT_PAGES/konu_anlatim_pages/TYT_konu_anlatim_page5.dart';
import 'package:flutter/material.dart';

import '../../../product/project_colors.dart';

class TYTKonuAnlatimButton5 extends StatelessWidget {
  const TYTKonuAnlatimButton5({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TYTKonu5Page()));
              },
              child: Padding(
