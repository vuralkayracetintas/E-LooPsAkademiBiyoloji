...
import 'package:biyoloji_16_03_2023/pages/AYT_PAGES/ayt_konu_pages/AYT_konu_anlatim_page3.dart';
import 'package:biyoloji_16_03_2023/product/project_colors.dart';
import 'package:flutter/material.dart';

class AYTKonuAnlatimButton3 extends StatelessWidget {
  const AYTKonuAnlatimButton3({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const AYTKonu3Page()));
              },
              child: Padding(
