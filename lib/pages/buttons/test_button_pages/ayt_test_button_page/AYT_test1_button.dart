...
import 'package:biyoloji_16_03_2023/pages/AYT_PAGES/ayt_test_pages/AYT_test1.dart';
...
class AYTTest1Button extends StatelessWidget {
  const AYTTest1Button({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const AYTTest1()));
              },
              child: Padding(
