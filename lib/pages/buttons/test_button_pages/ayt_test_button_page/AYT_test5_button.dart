...
import 'package:biyoloji_16_03_2023/pages/AYT_PAGES/ayt_test_pages/AYT_test5.dart';
...
class AYTTest5Button extends StatelessWidget {
  const AYTTest5Button({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const AYTTest5()));
              },
              child: Padding(
