...
import 'package:biyoloji_16_03_2023/pages/AYT_PAGES/ayt_test_pages/AYT_test6.dart';
...
class AYTTest6Button extends StatelessWidget {
  const AYTTest6Button({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const AYTTest6()));
              },
              child: Padding(
