...
import 'package:biyoloji_16_03_2023/pages/AYT_PAGES/ayt_test_pages/AYT_test7.dart';
...
class AYTTest7Button extends StatelessWidget {
  const AYTTest7Button({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const AYTTest7()));
              },
              child: Padding(
