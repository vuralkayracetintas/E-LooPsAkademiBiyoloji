...
import 'package:biyoloji_16_03_2023/pages/AYT_PAGES/ayt_test_pages/AYT_test8.dart';
...
class AYTTest9Button extends StatelessWidget {
  const AYTTest9Button({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const AYTTest9()));
              },
              child: Padding(
