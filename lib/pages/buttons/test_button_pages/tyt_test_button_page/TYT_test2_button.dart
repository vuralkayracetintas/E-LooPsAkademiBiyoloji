...
import 'package:biyoloji_16_03_2023/pages/TYT_PAGES/test_pages/TYT_test2.dart';
import 'package:biyoloji_16_03_2023/product/project_colors.dart';
import 'package:flutter/material.dart';

class TYTTest2Button extends StatelessWidget {
  const TYTTest2Button({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const TYTTest2()));
              },
              child: Padding(
