...
import 'package:biyoloji_16_03_2023/pages/TYT_PAGES/test_pages/TYT_test7.dart';
import 'package:biyoloji_16_03_2023/product/project_colors.dart';
import 'package:flutter/material.dart';

class TYTTest7Button extends StatelessWidget {
  const TYTTest7Button({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const TYTTest7()));
              },
              child: Padding(
