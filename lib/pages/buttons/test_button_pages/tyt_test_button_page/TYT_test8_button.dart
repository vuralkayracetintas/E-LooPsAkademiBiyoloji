...
import 'package:biyoloji_16_03_2023/pages/TYT_PAGES/test_pages/TYT_test8.dart';
import 'package:biyoloji_16_03_2023/product/project_colors.dart';
import 'package:flutter/material.dart';

class TYTTest8Button extends StatelessWidget {
  const TYTTest8Button({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const TYTTest8()));
              },
              child: Padding(
